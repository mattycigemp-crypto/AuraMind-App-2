-- Fix broadcast_user_notification: pg_net 0.19.5 expects body as jsonb, not text.
-- The previous migration (20260725000000) cast body to ::text which causes a
-- function-not-found error because Postgres can't match text to the jsonb param.
