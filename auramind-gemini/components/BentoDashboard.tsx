...
const BentoDashboard: React.FC<BentoDashboardProps> = ({
  ...
  return (
    ...
    >
      {/* HEADER SECTION */}
      <motion.header variants={fadeUp} className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 relative z-10">
        ...
        <motion.div variants={fadeUp} className="xl:col-span-7 bg-white/[0.02] border border-white/5 rounded-[40px] p-8 sm:p-12 relative overflow-hidden group backdrop-blur-xl border-l border-t border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 relative z-10">
        ...
        <div className="xl:col-span-4 space-y-8">
          {/* LEADERBOARD */}
          <motion.div variants={fadeUp} className="bg-white/[0.02] border border-white/5 rounded-[40px] overflow-hidden backdrop-blur-xl border-l border-t border-white/10 p-2">
