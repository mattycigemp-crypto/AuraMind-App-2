...
const sections = [
    ...
    content: (
      <>
        <ul className="list-disc pl-5 space-y-1.5 text-zinc-700 dark:text-zinc-300">
          ...
          <li>You must notify us immediately of any unauthorized use of your account at <strong>support@auramind.app</strong>.</li>
  ...
  },
  {
    ...
    content: (
      <>
        <h4 className="text-md font-semibold text-zinc-900 dark:text-white mt-4 mb-2">Plans</h4>
        <ul className="list-disc pl-5 space-y-1.5 text-zinc-700 dark:text-zinc-300">
          <li><strong>Free Trial:</strong> New users receive a 14-day free trial with full access to the Service.</li>
          <li><strong>Monthly Protocol:</strong> $9.99/month, billed monthly.</li>
          <li><strong>Annual System:</strong> $3.99/month ($47.88/year), billed annually.</li>
          <li>Scholar plan pricing may vary and is offered at our discretion.</li>
        </ul>

        <h4 className="text-md font-semibold text-zinc-900 dark:text-white mt-4 mb-2">Payment Terms</h4>
        <ul className="list-disc pl-5 space-y-1.5 text-zinc-700 dark:text-zinc-300">
          ...
          <li>Refunds are provided on a case-by-case basis. Contact <strong>support@auramind.app</strong> for refund requests.</li>
          <li>Prices are in USD and may be subject to applicable taxes.</li>
        </ul>

        <h4 className="text-md font-semibold text-zinc-900 dark:text-white mt-4 mb-2">Cancellation</h4>
        <p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <h4 className="text-md font-semibold text-zinc-900 dark:text-white mt-4 mb-2">AI Output Disclaimer</h4>
        <ul className="list-disc pl-5 space-y-1.5 text-zinc-700 dark:text-zinc-300">
        ...
        <h4 className="text-md font-semibold text-zinc-900 dark:text-white mt-4 mb-2">Third-Party Providers</h4>
        <p>
        ...
        <h4 className="text-md font-semibold text-zinc-900 dark:text-white mt-4 mb-2">No Training on User Data</h4>
        <p>
  ...
  },
  {
    ...
    content: (
      <>
        <h4 className="text-md font-semibold text-zinc-900 dark:text-white mt-4 mb-2">Your Content</h4>
        <p>
        ...
        <h4 className="text-md font-semibold text-zinc-900 dark:text-white mt-4 mb-2">License to Us</h4>
        <p>
        ...
        <h4 className="text-md font-semibold text-zinc-900 dark:text-white mt-4 mb-2">AI-Generated Content</h4>
        <p>
        ...
        <h4 className="text-md font-semibold text-zinc-900 dark:text-white mt-4 mb-2">No Responsibility for User Content</h4>
        <p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul className="list-disc pl-5 space-y-1.5 text-zinc-700 dark:text-zinc-300">
          <li><strong>Notion:</strong> Import content from Notion via OAuth. Notion's terms apply to data accessed through this integration.</li>
          <li><strong>Schoology:</strong> Import courses and materials via OAuth. Schoology's terms apply to data accessed through this integration.</li>
          <li><strong>Obsidian:</strong> Import markdown files from Obsidian vaults. Requires user-initiated file upload.</li>
          <li><strong>Anki:</strong> Import Anki deck files (APKG format) via user-initiated file upload.</li>
        </ul>
        <p>
          These integrations are provided for your convenience. We are not responsible for the privacy practices, terms, or security of third-party platforms. You are responsible for complying with any applicable terms when using these integrations.
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        <h4 className="text-md font-semibold text-zinc-900 dark:text-white mt-4 mb-2">By You</h4>
        <p>
        ...
        <h4 className="text-md font-semibold text-zinc-900 dark:text-white mt-4 mb-2">By Us</h4>
        <p>
        ...
        <h4 className="text-md font-semibold text-zinc-900 dark:text-white mt-4 mb-2">Effect of Termination</h4>
        <p>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          We respect intellectual property rights and comply with the Digital Millennium Copyright Act (DMCA). If you believe content on our Service infringes your copyright, please submit a notice to:
        </p>
        <ul className="list-none space-y-1 text-zinc-700 dark:text-zinc-300">
          <li><strong>Email:</strong> dmca@auramind.app</li>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul className="list-none space-y-1 text-zinc-700 dark:text-zinc-300">
          <li><strong>General Inquiries:</strong> hello@auramind.app</li>
          <li><strong>Support:</strong> support@auramind.app</li>
          <li><strong>Legal:</strong> legal@auramind.app</li>
          <li><strong>DMCA:</strong> dmca@auramind.app</li>
          <li><strong>Address:</strong> AuraMind, Inc., 548 Market St, San Francisco, CA 94104</li>
        </ul>
      </>
    ),
    ...
    <div className="min-h-screen bg-zinc-950">
      ...
      <div className="sticky top-0 z-10 bg-zinc-950/80 backdrop-blur-md border-b border-zinc-800">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-4 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-lg font-bold text-zinc-900 dark:text-white">Terms of Service</h1>
