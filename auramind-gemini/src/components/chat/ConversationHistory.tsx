  ...
  return (
    <>
      <button
        ...
        className="relative w-9 h-9 shrink-0 rounded-lg bg-[#111118] border border-[#2A2A3A] flex items-center justify-center text-[#8A8AA3] hover:text-[#F0EFFE] hover:border-[#3A3A4F] transition-all"
      >
        <History size={13} />
        {sessions.length > 0 && (
