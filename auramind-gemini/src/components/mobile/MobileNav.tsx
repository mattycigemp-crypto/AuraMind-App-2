...
const MobileNav: React.FC = () => {
  return (
    <nav className="fixed bottom-0 left-0 right-0 h-16 bg-zinc-900/90 backdrop-blur-sm border-t border-muted/20 z-50 safe-area-bottom" style={{ height: 'calc(4rem + var(--safe-bottom, 0px))' }}>
